...
class TestGreenVerificationClient:
    ...
    def test_get_green_verifications_with_all_params(self, mock_get: Mock) -> None:
        ...
        mock_get.assert_called_once_with("PropertyGreenVerification", params=expected_params)

    @patch("wfrmls.green_verification.GreenVerificationClient.get")
    def test_get_green_verifications_top_limit_enforcement(self, mock_get: Mock) -> None:
    ...
    def test_get_green_verifications_select_string(self, mock_get: Mock) -> None:
        ...
        self.client.get_green_verifications(select="GreenVerificationKey,GreenVerificationType")
    ...
    def test_get_green_verification(self, mock_get: Mock) -> None:
        ...
        mock_get.assert_called_once_with(f"PropertyGreenVerification('{verification_key}')")
        assert result == mock_response
    ...
    @patch("wfrmls.green_verification.GreenVerificationClient.get_green_verifications")
    def test_get_verifications_for_property_with_existing_filter(self, mock_get_verifications: Mock) -> None:
        ...
        expected_filter = "ListingKey eq '12345' and GreenVerificationStatus eq 'Active'"
